...
object DestinationCatalog {
    ...
    val ALL: List<DestinationResponse> = listOf(
        // 일본
        DestinationResponse("도쿄", "일본", "JP", 35.6762, 139.6503, true, "일본", "신주쿠, 시부야, 아키하바라", "https://images.unsplash.com/photo-1540959179-fd27c7e4b24d?w=400&q=80"),
        ...
        DestinationResponse("후쿠오카", "일본", "JP", 33.5904, 130.4017, true, "일본", "후쿠오카, 유후인, 벳부", null),
        ...
        DestinationResponse("나고야", "일본", "JP", 35.1815, 136.9066, true, "일본", "나고야, 다카야마, 시라카와고", null),
        ...
        DestinationResponse("다낭", "베트남", "VN", 16.0544, 108.2022, true, "동남아시아", "다낭, 호이안, 후에", null),
        DestinationResponse("세부", "필리핀", "PH", 10.3157, 123.8854, true, "동남아시아", "세부, 보홀, 막탄", null),

        // 유럽
        DestinationResponse("파리", "프랑스", "FR", 48.8566, 2.3522, true, "유럽", "에펠탑, 루브르, 샹젤리제", "https://images.unsplash.com/photo-1502602439-6c4e8291cf6b?w=400&q=80"),
        ...
        DestinationResponse("암스테르담", "네덜란드", "NL", 52.3676, 4.9041, true, "유럽", "운하, 반고흐미술관, 안네의집", null),

        // 미주/오세아니아
        DestinationResponse("뉴욕", "미국", "US", 40.7128, -74.0060, true, "미주/오세아니아", "맨해튼, 센트럴파크, 자유의여신상", "https://images.unsplash.com/photo-1538970272646-f61fabb3bcc2?w=400&q=80"),
        DestinationResponse("하와이", "미국", "US", 21.3069, -157.8583, true, "미주/오세아니아", "와이키키, 마우이, 빅아일랜드", "https://images.unsplash.com/photo-1542259009477-d625272157b7?w=400&q=80"),
        ...
        // 중화권
        DestinationResponse("홍콩", "홍콩", "HK", 22.3193, 114.1694, true, "중화권", "빅토리아피크, 침사추이, 란콰이펑", null),
        DestinationResponse("타이베이", "대만", "TW", 25.0330, 121.5654, true, "중화권", "지우펀, 101빌딩, 예류", null),
        ...
        DestinationResponse("제주", "대한민국", "KR", 33.4996, 126.5312, false, "국내", "성산일출봉, 한라산, 협재해수욕장", null),
        DestinationResponse("부산", "대한민국", "KR", 35.1796, 129.0756, false, "국내", "해운대, 광안리, 감천문화마을", null),
        DestinationResponse("경주", "대한민국", "KR", 35.8562, 129.2247, false, "국내", "불국사, 첨성대, 동궁과월지", null),
        DestinationResponse("속초", "대한민국", "KR", 38.2070, 128.5919, false, "국내", "설악산, 청초호, 속초해수욕장", null),
        DestinationResponse("강릉", "대한민국", "KR", 37.7519, 128.8760, false, "국내", "경포대, 정동진, 안목커피거리", null),
        DestinationResponse("전주", "대한민국", "KR", 35.8242, 127.1480, false, "국내", "전주한옥마을, 비빔밥, 막걸리골목", null),
        DestinationResponse("여수", "대한민국", "KR", 34.7604, 127.6622, false, "국내", "돌산도, 여수밤바다, 오동도", null)
    )
